...
class OrderService {
    constructor() {
        ...
        this.getOrder = async (idUser) => {
            let sql = `select o.time,o.totalPoint,o.status,o.receiver, o.address,o.phone, u.username from shop.order o join user u on o.idUser = u.id where  o.status != 'buying'`;
